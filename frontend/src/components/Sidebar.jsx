...
const Sidebar = () => {
  ...
  return (
    <aside className="h-full w-20 lg:w-80 border-r border-base-300 flex flex-col bg-base-100 transition-all duration-300">
      {/* Header */}
      <div className="border-b border-base-300 p-4 bg-base-200/50">
        {/* Title and Tab Toggle */}
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-lg font-semibold text-base-content hidden lg:block">
            Messages
          </h2>
        ...
        <div className="relative mb-3">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 bg-base-200 border border-base-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all duration-200"
          />
        </div>
        ...
        <div className="flex items-center justify-between">
          ...
          {tab === "private" && (
            <label className="cursor-pointer flex items-center gap-2 text-sm">
              ...
              <span className="text-xs text-base-content/50 bg-base-300 px-2 py-1 rounded-full">
                ...
                {filteredUsersBySearch.length === 0 ? (
                  ...
                  filteredUsersBySearch.map((user) => (
                    <button
                      ...
                      className={`w-full p-3 flex items-center gap-3 rounded-xl hover:bg-base-200 transition-all duration-200 group relative ${
                    ...
                    >
                      ...
                      <div className="relative flex-shrink-0">
                        <img
                          ...
                          alt={user.fullName}
                          className="size-12 object-cover rounded-full border-2 border-base-300 group-hover:border-primary/30 transition-colors duration-200"
                        />
                ...
                {filteredGroupsBySearch.length === 0 ? (
                  ...
                  filteredGroupsBySearch.map((group) => (
                    <button
                      ...
                      className={`w-full p-3 flex items-center gap-3 rounded-xl hover:bg-base-200 transition-all duration-200 group ${
